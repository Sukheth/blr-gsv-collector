...
for i, feature in gdf.iterrows():
    ...
    # Use namecol field for BBMP zones
    zone_field = "namecol" if "namecol" in feature else "zone_name" if "zone_name" in feature else list(feature.index)[0]
    feature_dict[feature[zone_field]] = feature_gdf
